                                ...
                                >
                                    ...
                                    >
                                        <Box
                                            ...
                                            <Box style={{ display: "flex", position: "absolute", left: 0 }}>
                                                <Box
                                                    className={classes.iconStatus}
                                                    style={{ backgroundColor: "#56b26e" }}
                                                />
                                                <Typography style={{ fontSize: 10, color: "#fff" }}>Cam Name</Typography>
                                            </Box>
                                            <Box style={{
                                                marginLeft: "auto",
                                                marginRight: "auto",
                                                ...
                                                <Typography style={{ fontSize: 10, color: "#fff", marginRight: "9px" }}>2022/12/01 09:00:00</Typography>
                                                <AdjustIcon style={{ color: "red", width: "12px", height: 12 }} />
                                            </Box>
                                        </Box>
                                    </Box>
                                    <Box
                                ...
                                <div className="body-detail-container">
                                    <div className="body-header body-detail-header">
                                        <Typography>
                                            ...
                                            {(typeModal === 6 || typeModal === 15) && "Object details"}
                                        </Typography>
                                    </div>
